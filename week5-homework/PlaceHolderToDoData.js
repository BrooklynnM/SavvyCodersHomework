...
const user9info = toDos.filter(info => info.userId === 9);
//console.log(user9info);

const user9todos = user9info.forEach(toDo => console.log(toDo.title));

const user9Incompletes = user9info.reduce(
  (acc, curr) => {
